...
-- dcrosby snarked this dir from the github repo
-- https://github.com/karai17/Simple-Tiled-Implementation.git
--  @ 6ff3496cca12708fa38c19a2b26ff40d31a2ed0c
...
local function new(map, plugins, ox, oy)
	...
	if type(map) == "table" then
		...
		-- Load map
		local mapfn=love.filesystem.load(map)
		if mapfn then
		  map = setmetatable(mapfn(), Map)
		else
			error("STI FAIL: cannot load '"..map.."' via love.filesystem.load()")
		end
	end
